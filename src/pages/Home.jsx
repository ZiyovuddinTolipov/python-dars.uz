...
const Home = () => {
    return (
        <div className="h-[100vh] p-4 ">
            <div className="max-w-[1400px] h-full max-h-[800px] bg-black/30 backdrop-blur-md  mx-auto flex flex-col-reverse md:flex-row rounded-3xl p-10 relative">
                <div className="w-full md:w-1/2 flex flex-col justify-center items-start relative gap-3">
                    ...
                    <h2 className="text-2xl md:text-5xl font-Kanit font-[700] text-slate-50"> Kelajak hayotingiz uchun investitsiya qiling.</h2>
